      ...
      <div className="relative isolate px-6 pt-14 pb-32 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#646cff] to-[#61dafb] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
          />
        </div>
