...
export function Education() {
    const job_details =
    {
        education: [
            {
                id: 1,
                education_from: "McMaster University",
                country: "Hamilton, ON",
                education_year_start: "2023",
                education_year_end: "2028 (Expected)",
                program: "Bachelor of Engineering – Electrical Engineering CO-OP"
            }
        ...
        experience: [
            {
                id: 1,
                company: "McMaster Robotics Submarine",
                year_start: "2025",
                year_end: "present",
                country: "McMaster University",
                ocupation: "Electrical Engineer"
            },
            {
                id: 2,
                company: "CRAFTS Childcare Management",
                year_start: "May 2024",
                year_end: "Sept 2024",
                country: "Toronto, ON",
                ocupation: "Design & Testing Intern"
            }
        ]
    }
    ...
    return (
        <div id="education" className="bg-white">
            <div className="tools-sec py-24">
                ...
                <h2 className="pt-1 text-4xl text-center font-semibold tracking-tight text-balance text-indigo-300 sm:text4xl">Professional Journey</h2>
                    ...
                    <div className="col-span-6 not-lg:col-span-12">
                        <div className="card">
                            <div className="card-heading text-2xl font-semibold border-b border-gray-300 pb-5 mb-5 flex gap-4 not-lg:text-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#a3b3ff" className="size-8 educ-icon">
